    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          <div className="w-12 h-12 border-4 border-slate-200 rounded-full animate-spin border-t-primary mx-auto" />
  ...
  if (!election) {
    return (
      <div className="min-h-screen bg-white flex flex-col items-center justify-center p-4">
        ...
        <h2 className="text-xl font-bold text-slate-900">ไม่พบการเลือกตั้ง</h2>
        <p className="text-sm text-slate-500 mt-2">
          การเลือกตั้งนี้อาจถูกลบหรือยังไม่เปิดให้ลงคะแนน
        </p>
        <Link
          href="/"
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  ...
                  disabled={confirmStudentId.length !== 4}
